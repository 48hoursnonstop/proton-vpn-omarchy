...
The plugin reuses or translates selected icon geometry and status assets from
the GPL-licensed Proton VPN Android and Proton Core Android projects. Source
provenance is retained in the asset comments and in the corresponding source
archive attached to each release. Those assets remain subject to their
upstream copyright notices and licenses.
